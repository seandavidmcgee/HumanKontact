...
public class SwiftPrompts : NSObject {
    ...
    public class func drawSwiftPrompt(#frame: CGRect, backgroundColor: UIColor, headerBarColor: UIColor, bottomBarColor: UIColor, headerTxtColor: UIColor, contentTxtColor: UIColor, outlineColor: UIColor, topLineColor: UIColor, bottomLineColor: UIColor, dismissIconButton: UIColor, promptText: String, textSize: CGFloat, topBarVisibility: Bool, bottomBarVisibility: Bool, headerText: String, headerSize: CGFloat, topLineVisibility: Bool, bottomLineVisibility: Bool, outlineVisibility: Bool, dismissIconVisibility: Bool) {
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRectMake(frame.minX + floor(frame.width * 0.01778 + 0.5), frame.minY + 9, floor(frame.width * 0.98667 + 0.5) - floor(frame.width * 0.01778 + 0.5), frame.height - 19), cornerRadius: 0)
        ...
        if (outlineVisibility) {
            //// Rectangle 6 Drawing
            let rectangle6Path = UIBezierPath(roundedRect: CGRectMake(frame.minX + floor(frame.width * 0.01778 + 0.5), frame.minY + 9, floor(frame.width * 0.98667 + 0.5) - floor(frame.width * 0.01778 + 0.5), frame.height - 19), cornerRadius: 0)
        ...
        //// Text Drawing
        let textRect = CGRectMake(frame.minX + 13, frame.minY + 23, frame.width - 26, frame.height - 109)
        let textStyle = NSMutableParagraphStyle.defaultParagraphStyle().mutableCopy() as! NSMutableParagraphStyle
        textStyle.alignment = NSTextAlignment.Left

        let textFontAttributes = [NSFontAttributeName: UIFont(name: "AvenirNext-Regular", size: textSize)!, NSForegroundColorAttributeName: contentTxtColor, NSParagraphStyleAttributeName: textStyle]
        ...
        //// Text 2 Drawing
        let text2Rect = CGRectMake(frame.minX + floor(frame.width * 0.05333 + 0.5), frame.minY + 15, floor(frame.width * 0.93778 + 0.5) - floor(frame.width * 0.05333 + 0.5), 34)
        ...
        let text2FontAttributes = [NSFontAttributeName: UIFont(name: "AvenirNext-Regular", size: headerSize)!, NSForegroundColorAttributeName: headerTxtColor, NSParagraphStyleAttributeName: text2Style]
